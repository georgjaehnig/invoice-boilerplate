...
\begin{flushright}
  \small
	$city$, $if(date)$$date$$else$\today$endif$
\end{flushright}
...
\begin{spreadtab}{{tabular}[t t t]{lp{10.7cm}r}}
  \hdashline[1pt/1pt]
  @ \noalign{\vskip 2mm} \textbf{$label-position$} & @ \textbf{$label-description$} & @ \textbf{$label-price$} \\ \hline
  ...
  $if(VAT)$
    @ & @ \multicolumn{1}{r}{$label-subtotal$}                & :={sum(c1:[0,-1])} \\ \hhline{~~-}
    @ & @ \multicolumn{1}{r}{$label-vat$ $VAT$\%:}               & $VAT$/100*[0,-1] \\ \hhline{~~-}
		@ & @ \multicolumn{1}{r}{\textbf{$label-total$}}   & \textbf{:={[0,-1]+[0,-2]}} \\ \hhline{~~-}
  $else$
		@ & @ \multicolumn{1}{r}{\textbf{$label-total$}}   & \textbf{:={sum(c1:[0,-1])} } \\ \hhline{~~-}
  $endif$
\end{spreadtab}
